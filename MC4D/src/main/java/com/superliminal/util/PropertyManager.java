...
public class PropertyManager extends Properties {
     ...
     */
    public final static PropertyManager userprefs = new LocalProps(new File(PlatformUtils.getBinDir(), PRODUCT_NAME+".props"));
    static {
		System.out.println("Launch dir: " + PlatformUtils.getBinDir());
    }
